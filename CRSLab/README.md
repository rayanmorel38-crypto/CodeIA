...
![Release](https://img.shields.io/badge/Release-unknown-lightgrey.svg)
...
```bash
git clone <CRSLab_repository_url> && cd CRSLab
pip install -e .
```
...
| :----------------------------------------------------------: | :-----: | :--------: | :----------: | :-------------: | :--------: | :--------: |
|       ReDial (redialdata)        | 10,006  |  182,150   |    Movie     |       --        |  DBpedia   | ConceptNet |
|       TG-ReDial                   | 10,000  |  129,392   |    Movie     |   Topic Guide   | CN-DBpedia |   HowNet   |
|       GoRecDial (arXiv)           |  9,125  |  170,904   |    Movie     |  Action Choice  |  DBpedia   | ConceptNet |
|       DuRecDial (arXiv)           | 10,200  |  156,000   | Movie, Music |    Goal Plan    | CN-DBpedia |   HowNet   |
...
Please let us know if you encounter a bug or have any suggestions by filing an issue (issue tracker).
